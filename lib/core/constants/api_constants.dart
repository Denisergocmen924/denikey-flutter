class ApiConstants {
  ...
  static const String loginSalt          = '/api/v1/auth/login-salt';
  ...
  static String deviceDelete(String id)    => '/api/v1/devices/$id/permanent';
  static String deviceRename(String id)    => '/api/v1/devices/$id/rename';
